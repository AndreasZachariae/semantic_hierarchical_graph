...
def main():
    ...
    build_f = G.add_child_by_hierarchy(hierarchy=[], name="Building F", pos=(-5, 0, 0))
    floor_f0 = G.add_child_by_hierarchy(hierarchy=["Building F"], name="Floor 0", pos=(0, 0, 0))
    floor_f1 = G.add_child_by_hierarchy(hierarchy=["Building F"], name="Floor 1", pos=(0, 0, 1))
    floor_f2 = G.add_child_by_hierarchy(hierarchy=["Building F"], name="Floor 2", pos=(0, 0, 2))
    floor_f3 = G.add_child_by_hierarchy(hierarchy=["Building F"], name="Floor 3", pos=(0, 0, 3))
    floor_a0 = G.add_child_by_hierarchy(hierarchy=["Building A"], name="Floor 0", pos=(0, 0, 0))
    floor_a1 = G.add_child_by_hierarchy(hierarchy=["Building A"], name="Floor 1", pos=(0, 0, 1))
    floor_a2 = G.add_child_by_hierarchy(hierarchy=["Building A"], name="Floor 2", pos=(0, 0, 2))
    floor_a3 = G.add_child_by_hierarchy(hierarchy=["Building A"], name="Floor 3", pos=(0, 0, 3))
    floor_f0.add_child_by_name(name="Staircase", pos=(0, -1, 0), is_leaf=True)
    floor_f0.add_child_by_name(name="Lab", pos=(0, 0, 0), is_leaf=True)
    floor_f0.add_child_by_name(name="Workshop", pos=(1, -1, 0), is_leaf=True)
    floor_f0.add_child_by_name(name="RoboEduLab", pos=(0, 1, 0), is_leaf=True)
    floor_f1.add_child_by_name(name="Staircase", pos=(0, -1, 0), is_leaf=True)
    floor_f1.add_child_by_name(name="IRAS", pos=(0, 1, 0), is_leaf=True)
    floor_f1.add_child_by_name(name="xLab", pos=(1, 1, 0), is_leaf=True)
    floor_f1.add_child_by_name(name="Kitchen", pos=(2, 1, 0), is_leaf=True)
    floor_f1.add_child_by_name(name="Corridor", pos=(1, 0, 0), is_leaf=True)
    floor_f1.add_child_by_name(name="Meeting Room", pos=(1, -1, 0), is_leaf=True)
    floor_f2.add_child_by_name(name="Staircase", pos=(0, -1, 0), is_leaf=True)
    floor_f2.add_child_by_name(name="Corridor", pos=(1, 0, 0), is_leaf=True)
    floor_f2.add_child_by_name(name="Seminar Room 1", pos=(0, 0, 0), is_leaf=True)
    floor_f2.add_child_by_name(name="Seminar Room 2", pos=(0, 1, 0), is_leaf=True)
    floor_f2.add_child_by_name(name="Seminar Room 3", pos=(2, -1, 0), is_leaf=True)
    floor_f2.add_child_by_name(name="Office", pos=(2, 1, 0), is_leaf=True)
    floor_f2.add_child_by_name(name="Kitchen", pos=(3, 1, 0), is_leaf=True)
    floor_f3.add_child_by_name(name="Staircase", pos=(0, -1, 0), is_leaf=True)
    floor_f3.add_child_by_name(name="Office", pos=(1, 0, 0), is_leaf=True)
    floor_a0.add_child_by_name(name="Staircase", pos=(0, -1, 0), is_leaf=True)
    floor_a0.add_child_by_name(name="Entrance", pos=(1, 0, 0), is_leaf=True)
    floor_a1.add_child_by_name(name="Cantina", pos=(1, 0, 0), is_leaf=True)
    floor_a1.add_child_by_name(name="Staircase", pos=(0, -1, 0), is_leaf=True)
